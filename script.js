...
async function createMusikDivs() {
  ...
  const response = await fetch('http://192.168.0.54:5000/music');
  const myJson = await response.json();
  console.log(JSON.stringify(myJson));
...
async function fetchLock() {
  ...
  const response = await fetch('http://192.168.0.54:5000/action/lock');
  const myJson = await response.json();
  console.log(JSON.stringify(myJson));
...
async function fetchUnLock() {
  ...
  const response = await fetch('http://192.168.0.54:5000/action/unlock');
  const myJson = await response.json();
  console.log(JSON.stringify(myJson));
